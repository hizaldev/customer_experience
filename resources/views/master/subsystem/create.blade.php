            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Tambah Subsystem Penyaluran </h3>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                            ...
                            <div class="row">
                              <div class="col-md-4">
                                ...
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control @error('subsystem') is-invalid @enderror" name="subsystem" id="subsystem" placeholder="Masukan Subsystem Penyaluran">
                                  @error('subsystem')
