                        ...
                        <table id="example" class="table table-vcenter card-table table-striped">
                          <thead>
                            <tr>
                              <th class="w-1"></th>
                              <th>
                                <input type="text" class="form-control filter-input" placeholder="Kode Tegangan" data-column="1">
                              </th>
                              <th>
                                <input type="text" class="form-control filter-input" placeholder="Tegangan" data-column="2">
                              </th>
                              <th>
                                <input type="text" class="form-control filter-input" placeholder="Keterangan" data-column="3">
                              </th>
                              @can('master_tegangan-edit')
                                  <th ></th>
                              @endcan
                              @can('master_tegangan-delete')
                                  <th></th>
                              @endcan
                            </tr>
                            <tr>
    ...
    <script>
        var datatables = $('#example').DataTable({
            ...
            columns : [
                ...
                {data: 'tegangan_id', name: 'tegangan'},
            ...
            buttons : [ 
                @can('master_tegangan-create')
                    {
                        text: 'Tambah',
                        className: 'btn btn-primary btn-sm btn-fw mb-4 mr-2 p-1',
                        action: function ( e, dt, button, config ) {
                            window.location = '{{ route('tegangan.create') }}';
                        }        
                    },
                @endcan
                {
