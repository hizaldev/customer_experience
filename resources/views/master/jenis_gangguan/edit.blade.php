            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Edit Jenis Gangguan </h3>
                </div>
                <div class="card-body">
                  @if ($errors->any())
                  ...
                  @endif
                  <form action="{{ route('jenisGangguan.update', $item->id)}}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf

                    <div class="form-group mb-3">
                      <label for="fungsi">Jenis Gangguan</label>
                      <input type="text" class="form-control @error('jenis_gangguan') is-invalid @enderror" value="{{$item->jenis_gangguan}}" name="jenis_gangguan" id="jenis_gangguan" placeholder="Masukan Jenis Gangguan">
