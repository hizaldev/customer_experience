            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Tipe Gangguan</h3>
                </div>
                <div class="card-body">
                        ...
                        <table id="example" class="table table-vcenter card-table table-striped">
                          <thead>
                            <tr>
                              ...
                              @can('master_tipe_gangguan-edit')
                                  <th ></th>
                              @endcan
                              @can('master_tipe_gangguan-delete')
                                  <th></th>
                              @endcan
                            </tr>
                            <tr>
...
@push('addon-script')
    ...
    <script>
        var datatables = $('#example').DataTable({
            ...
            buttons : [ 
                @can('master_tipe_gangguan-create')
                    {
                        text: 'Tambah',
                        className: 'btn btn-primary btn-sm btn-fw mb-4 mr-2 p-1',
                        action: function ( e, dt, button, config ) {
                            window.location = '{{ route('tipeGangguan.create') }}';
                        }        
                    },
                @endcan
                {
