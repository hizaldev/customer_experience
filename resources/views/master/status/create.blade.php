                    ...
                    @if ($errors->any())
                        ...
                        <form action="{{ route('status.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('id_status') is-invalid @enderror" name="id_status" id="id_status" placeholder="Masukan Kode Status">
                                @error('id_status')
                            ...
                            <div class="form-group mb-3">
                              ...
                              <input type="text" class="form-control @error('status') is-invalid @enderror" name="status" id="tegangan" placeholder="Masukan Status">
                              @error('status')
                                  <span class="invalid-feedback" role="alert">
                                      <strong>{{ $message }}</strong>
                                  </span>
