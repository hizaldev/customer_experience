            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Tambah Data Gangguan </h3>
                </div>
                <div class="card-body">
                        @if ($errors->any())
                        ...
                        @endif
                        <form action="{{ route('gangguan.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group mb-3">
                              ...
                              <select name="upt_id" class="form-control @error('level_upt') is-invalid @enderror" id="level_upt" required>
                                  ...
                                  @foreach ( $unit as $units )
                                      <option value="{{$units->id}}" {{$selectUnit == $units->id ? 'selected' : ''}}>{{$units->description}}</option>
                                  @endforeach
                              </select>
                              @error('level_upt')
                            ...
                            <div class="form-group mb-3">
                              ...
                              <select name="ultg_id" class="form-control @error('level_ultg') is-invalid @enderror" id="level_ultg">
                                  ...
                                  @foreach ( $ultg as $ultg )
                                      <option value="{{$ultg->id}}" {{$selectUltg == $ultg->id ? 'selected' : ''}}>{{$ultg->description}}</option>
                                  @endforeach
                              </select>
                              @error('level_ultg')
                                  <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group mb-3">
                              ...
                              <select name="substation_id" class="form-control @error('level_substation') is-invalid @enderror js-example-basic-single" id="level_substation">
                                  ...
                                  @foreach ( $substation as $gi )
                                      <option value="{{$gi->id}}" {{$selectSubstation == $gi->id ? 'selected' : ''}}>{{$gi->description}}</option>
                                  @endforeach
                              </select>
                            ...
                            <div class="form-group mb-3">
                              ...
                              <input type="text" class="form-control @error('description') is-invalid @enderror" name="description" id="description" placeholder="Masukan Deskripsi Gangguan">
                              @error('description')
                                  <span class="invalid-feedback" role="alert">
                                      <strong>{{ $message }}</strong>
                                  </span>
                            ...
                            <div class="form-group mb-3">
                              ...
                              <input type="datetime-local" class="form-control @error('tgl_gangguan') is-invalid @enderror" name="tgl_gangguan" id="tgl_gangguan">
                              @error('tgl_gangguan')
                                  <span class="invalid-feedback" role="alert">
                                      <strong>{{ $message }}</strong>
                                  </span>
                              ...
                              <div class="form-selectgroup">
                                @foreach ( $jenisGangguan as $jenis )
                                  <label class="form-selectgroup-item">
                                    <input type="radio" name="jenis_gangguan_id" value="{{$jenis->id}}" class="form-selectgroup-input">
                            ...
                            <div class="form-group mb-3">
                              ...
                              <select name="tipe_gangguan_id" class="form-control @error('tipe_gangguan_id') is-invalid @enderror" id="tipe_gangguan_id" required>
                                  ...
                                  @foreach ( $tipeGangguan as $tipe )
                                      <option value="{{$tipe->id}}" >{{$tipe->tipe_gangguan}}</option>
                                  @endforeach
                              </select>
                              ...
                              <div class="mb-3">
                                ...
                                <div>
                                  <label class="form-check">
                                    <input class="form-check-input" type="checkbox" name="is_main_gangguan">
                            ...
                            <div class="form-group mb-3">
                              ...
                              <select name="subsystem_id" class="form-control @error('subsystem_id') is-invalid @enderror" id="subsystem_id" required>
                                  ...
                                  @foreach ( $subsystem as $system )
                                      <option value="{{$system->id}}" >{{$system->subsystem}}</option>
                                  @endforeach
                              </select>
                              @error('subsystem_id')
                                  <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group mb-3">
                              ...
                              <input type="text" class="form-control @error('cuaca') is-invalid @enderror" name="cuaca" id="cuaca" placeholder="Masukan Cuaca">
                              @error('cuaca')
                                  <span class="invalid-feedback" role="alert">
                                      <strong>{{ $message }}</strong>
                                  </span>
                            ...
                            <div class="form-group mb-3">
                              ...
                              <textarea class="form-control" name="anounciator" rows="6" placeholder="Announciator"></textarea>
                              @error('anounciator')
                                  <span class="invalid-feedback" role="alert">
                                      <strong>{{ $message }}</strong>
                                  </span>
                            ...
                            <div class="form-group mb-3">
                              ...
                              <textarea class="form-control" name="indikasi_relay" rows="6" placeholder="Indikasi Relay"></textarea>
                            ...
                            <div class="row">
                              <div class="col-md-3">
                                <div class="mb-3">
                                  ...
                                  <div class="input-group mb-2">
                                    <input type="number" step="any" class="form-control  @error('arus_gangguan') is-invalid @enderror" name="arus_gangguan"  placeholder="000.00">
                              ...
                              <div class="col-md-3">
                                <div class="mb-3">
                                  ...
                                  <div class="input-group mb-2">
                                    <input type="number" step="any" class="form-control  @error('arus_gangguan_s') is-invalid @enderror" name="arus_gangguan_s"  placeholder="000.00">
                                    <span class="input-group-text">
                                      A
                                    </span>
                                  </div>
                              ...
                              <div class="col-md-3">
                                  <div class="mb-3">
                                    ...
                                    <div class="input-group mb-2">
                                      <input type="number" step="any" class="form-control  @error('arus_gangguan_t') is-invalid @enderror" name="arus_gangguan_t"  placeholder="000.00">
                                      <span class="input-group-text">
                                        A
                                      </span>
                                    </div>
                              ...
                              <div class="col-md-3">
                                <div class="mb-3">
                                  ...
                                  <div class="input-group mb-2">
                                    <input type="number" step="any" class="form-control  @error('arus_gangguan_n') is-invalid @enderror" name="arus_gangguan_n"  placeholder="000.00">
                                    <span class="input-group-text">
                                      A
                                    </span>
                                  </div>
                            ...
                            <div class="row">
                              <div class="col-md-4">
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control @error('count_cb_r') is-invalid @enderror" name="count_cb_r" id="count_cb_r" placeholder="">
                                  @error('count_cb_r')
                                      <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                      </span>
                              ...
                              <div class="col-md-4">
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control @error('count_cb_s') is-invalid @enderror" name="count_cb_s" id="count_cb_s" placeholder="">
                                  @error('count_cb_s')
                                      <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                      </span>
                              ...
                              <div class="col-md-4">
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control @error('count_cb_t') is-invalid @enderror" name="count_cb_t" id="count_cb_t" placeholder="">
                                  @error('count_cb_t')
                                      <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                      </span>
                            ...
                            <div class="row">
                              <div class="col-md-4">
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control @error('count_la_r') is-invalid @enderror" name="count_la_r" id="count_la_r" placeholder="">
                                  @error('count_la_r')
                                      <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                      </span>
                              ...
                              <div class="col-md-4">
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control @error('count_la_s') is-invalid @enderror" name="count_la_s" id="cuaca" placeholder="">
                                  @error('count_la_s')
                                      <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                      </span>
                              ...
                              <div class="col-md-4">
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control @error('cuaca') is-invalid @enderror" name="count_la_t" id="count_la_t" placeholder="">
                                  @error('count_la_t')
                                      <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                      </span>
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                <div class="mb-3">
                                  ...
                                  <div class="input-group mb-2">
                                    <input type="number" step="any" class="form-control  @error('beban_sebelum_mw') is-invalid @enderror" name="beban_sebelum_mw"  placeholder="000.00">
                                    <span class="input-group-text">
                                      MW
                                    </span>
                                  </div>
                              ...
                              <div class="col-md-6">
                                <div class="mb-3">
                                  ...
                                  <div class="input-group mb-2">
                                    <input type="number" step="any" class="form-control  @error('beban_sebelum_mvar') is-invalid @enderror" name="beban_sebelum_mvar"  placeholder="000.00">
                                    <span class="input-group-text">
                                      MVar
                                    </span>
                                  </div>
                            ...
                            <div class="form-group mb-3">
                              ...
                              <textarea class="form-control" name="penyebab_gangguan" rows="6" placeholder="Penyebab Gangguan"></textarea>
      ...
      $(document).ready(function() {
        ...
        $('#level_substation').on('change', function() {
            ...
            if(idGi) {
                ...
                $('select[name="subsystem_id"]').empty();
            }
        });
