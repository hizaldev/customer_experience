                        ...
                        <table id="example" class="table card-table table-vcenter text-nowrap">
                          <thead>
                            <tr>
                              <th class="w-1"></th>
                              <th>
                                <input type="text" class="form-control filter-input" placeholder="Permission" data-column="1">
                              </th>
                              <th>
                                <input type="text" class="form-control filter-input" placeholder="Guard Name" data-column="2">
                              </th>
                              @can('settings_permission-edit')
                                  <th ></th>
                              @endcan
                              @can('settings_permission-delete')
                                  <th></th>
                              @endcan
                            </tr>
                            <tr>
...
@push('addon-script')
    ...
    <script>
        var datatables = $('#example').DataTable({
            ...
            buttons : [ 
                @can('settings_permission-create')
                    {
                        text: 'Tambah',
