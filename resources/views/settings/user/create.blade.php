     ...
     <div class="page-header d-print-none">
        <div class="container-xl">
          <div class="row g-2 align-items-center">
            <div class="col">
              <h2 class="page-title">
                Tambah User Eksternal (User KTT)
              </h2>
            </div>
          </div>
        </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Tambah User Eksternal (User KTT) </h3>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                        ...
                        <form action="{{ route('users.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                              ...
                              <input type="text" class="form-control" name="name" value="{{old('name')}}" id="exampleInputName1" placeholder="Enter Nama">
                          </div>
                          <div class="form-group mb-3">
                            <label for="exampleInputName1">Email</label>
                            <input type="text" class="form-control" name="email" value="{{old('email')}}" id="exampleInputName1" placeholder="Enter Email">
                          </div>
                          <div class="form-group mb-3">
