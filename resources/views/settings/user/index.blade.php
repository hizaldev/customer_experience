                        ...
                        <table id="example" class="table card-table table-vcenter text-nowrap">
                          <thead>
                            <tr>
                              <th class="w-1"></th>
                              <th>
                                <input type="text" class="form-control filter-input" placeholder="Nama" data-column="1">
                              </th>
                              <th>
                                <input type="text" class="form-control filter-input" placeholder="Email" data-column="2">
                              </th>
                              <th>
                                <input type="text" class="form-control filter-input" placeholder="Role" data-column="3">
                              </th>
                              <th>
                                <input type="text" class="form-control filter-input" placeholder="Status User" data-column="4">
                              </th>
                              @can('settings_user-edit')
                                  <th ></th>
                              @endcan
                              @can('settings_user-delete')
                                  <th></th>
                              @endcan
                            </tr>
                            <tr>
