            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Unit Layanan (Level 3)</h3>
                </div>
                <div class="card-body">
                        ...
                        <table id="example" class="table table-vcenter card-table table-striped">
                          <thead>
                            <tr>
                              ...
                              @can('lokasi_unit_layanan-edit')
                                  <th ></th>
                              @endcan
                              @can('lokasi_unit_layanan-delete')
                                  <th></th>
                              @endcan
                            </tr>
                            <tr>
...
@push('addon-script')
    ...
    <script>
        var datatables = $('#example').DataTable({
            ...
            buttons : [ 
                @can('lokasi_unit_layanan-create')
                    {
                        text: 'Tambah',
                        className: 'btn btn-primary btn-sm btn-fw mb-4 mr-2 p-1',
                        action: function ( e, dt, button, config ) {
                            window.location = '{{ route('unitLayanan.create') }}';
                        }        
                    },
                @endcan
                {
