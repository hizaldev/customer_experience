            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Bay (Level 4)</h3>
                </div>
                <div class="card-body">
                        ...
                        <table id="example" class="table table-vcenter card-table table-striped">
                          <thead>
                            <tr>
                              ...
                              @can('lokasi_gardu_induk-edit')
                                  <th ></th>
                              @endcan
                              @can('lokasi_gardu_induk-delete')
                                  <th></th>
                              @endcan
                            </tr>
                            <tr>
...
@push('addon-script')
    ...
    <script>
        var datatables = $('#example').DataTable({
            ...
            buttons : [ 
                @can('lokasi_gardu_induk-create')
                    {
                        text: 'Tambah',
                        className: 'btn btn-primary btn-sm btn-fw mb-4 mr-2 p-1',
                        action: function ( e, dt, button, config ) {
                            window.location = '{{ route('garduInduk.create') }}';
                        }        
                    },
                @endcan
                {
