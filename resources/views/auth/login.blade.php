    ...
    <div class="row g-0 flex-fill">
      <div class="col-12 col-lg-6 col-xl-4 border-top-wide border-primary d-flex flex-column justify-content-center">
        <div class="container container-tight my-5 px-lg-5">
          <div class="text-center mb-4 fs-1">
            <a href="." class="navbar-brand navbar-brand-autodark" >Layanan Konsumen KTT</a>
          </div>
          <h2 class="h3 text-center mb-3">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col"><a href="{{ url('/oauth/redirect/pln') }}" class="btn btn-primary w-100">
            ...
            <div class="text-center text-muted mt-3">
                Application v{{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }})
            </div>
        </div>
      </div>
