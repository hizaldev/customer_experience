...
class PermissionController extends Controller
{
    ...
    {
        $this->middleware('permission:settings_permission-list|permission-create|settings_permission-edit|settings_permission-delete', ['only' => ['index','store']]);
        $this->middleware('permission:settings_permission-create', ['only' => ['create','store']]);
        $this->middleware('permission:settings_permission-edit', ['only' => ['edit','update']]);
        $this->middleware('permission:settings_permission-delete', ['only' => ['destroy']]);
    }
    /**
    ...
    public function index()
    {
        if(request()->ajax()){
            ...
            ->addColumn('delete', function($item){
                return '
                    <form action="'. route("$this->route.destroy", $item->id).'" method="POST" id="form" class="form-inline" onSubmit="if (confirm(`Are you sure delete this data?`)) run; return false">
