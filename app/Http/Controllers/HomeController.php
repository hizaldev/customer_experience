...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $selectUnit = $request->get('unit') ? $request->get('unit') : null;
    ...
    public function getDataGangguanTipeByUltg($unit, $tahun)
    {
        $query = DB::select("
            ...
            from locations l 
            left join (
                select g.ultg_id ,g.tipe_gangguan_id , count(*) as pht from gangguans g 
            ...
            left join (
                select g.ultg_id ,g.tipe_gangguan_id , count(*) as trf from gangguans g 
                where g.is_main_gangguan ='Ya' 
            ...
            left join (
                select g.ultg_id ,g.tipe_gangguan_id , count(*) as dia from gangguans g 
                where g.is_main_gangguan ='Ya' 
                and g.tipe_gangguan_id = '9b2e4a9d-b219-4f55-9505-0fef79bc6962' 
                and g.upt_id ='$unit'
                and g.tgl_gangguan BETWEEN '$tahun-01-01' and '$tahun-12-31'
            ...
            left join (
                select g.ultg_id ,g.tipe_gangguan_id , count(*) as kit from gangguans g 
                where g.is_main_gangguan ='Ya' 
                and g.tipe_gangguan_id = '9b2e4a9d-b219-4f55-9505-0fef79bc6962' 
                and g.upt_id ='$unit'
                and g.tgl_gangguan BETWEEN '$tahun-01-01' and '$tahun-12-31'
