...
{
    var $route = 'fungsi.index';
    var $path_view = 'master.fungsi';

    function __construct()
    {
        $this->middleware('permission:master_fungsi-list|master_fungsi-create|role-edit|master_fungsi-delete', ['only' => ['index', 'store']]);
        $this->middleware('permission:master_fungsi-create', ['only' => ['create', 'store']]);
        $this->middleware('permission:master_fungsi-edit', ['only' => ['edit', 'update']]);
        $this->middleware('permission:master_fungsi-delete', ['only' => ['destroy']]);
    }
    /**
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            'fungsi' => 'required|unique:functions,fungsi',
            'kd_fungsi' => 'required|unique:functions,kd_fungsi',
        ]);
        try {
